...
class Application(tk.Frame):
    def __init__(self, master=None):
        ...
        self.white = tk.Button(self, text="White(vs minmax)", font=("Times New Roman", 16), command=self.white_click)
        self.origi_color = self.white.cget("background")
        self.white.grid(row=1, column=0, padx=(115, 1), pady=20, ipadx=10, ipady=5)

        self.red = tk.Button(self, text="Red(vs NN)", font=("Times New Roman", 16), command=self.red_click)
    ...
    def red_click(self):
        self.red.config(bg="red", relief="sunken")
